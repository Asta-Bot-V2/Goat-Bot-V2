...
module.exports = {
  config: {
    name: "approve",
    aliases: ["app"],
    author: "ArYAN& modified ⧽⧽「 𝗞𝗬𝗟𝗘敦. ဗီူ 」⧼⧼", // don't change my credit
    countDown: 0,
    role: 2,
    category: "admin",
    shortDescription: {
  ...
  onStart: async function ({ event, api, args }) {
    ...
    switch (command) {
      case "list":
        let msg = "✅ 𝗔𝗽𝗽𝗿𝗼𝘃𝗲𝗱 𝗚𝗿𝗼𝘂𝗽𝘀\n\n💁🏻‍♂️ Here is the approved groups list\n";
      ...
      case "batch":
        ...
        let batchMessage = "ℹ️ 𝗔𝗽𝗽𝗿𝗼𝘃𝗮𝗹 𝗦𝘆𝘀𝘁𝗲𝗺\n\nApproved Groups:\n";
      ...
      case "search":
        ...
        let searchMsg = `ℹ️ 𝗔𝗽𝗽𝗿𝗼𝘃𝗮𝗹 𝗦𝘆𝘀𝘁𝗲𝗺\n\nSearch Results for "${searchTerm}":\n`;
        for (let index = 0; index < approvedData.length; index++) {
          const groupId = approvedData[index];
